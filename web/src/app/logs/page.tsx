        ...
        <CardContent className="p-0">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stone-100 px-5 py-4">
            <div className="flex flex-wrap items-center gap-3 text-sm text-stone-600">
              <span>Tổng {items.length} mục</span>
            ...
            <Table className="min-w-[900px]">
              <TableHeader>
                <TableRow>
                  ...
                  {isCallLog ? <TableHead>Tên khóa</TableHead> : null}
                  {isCallLog ? <TableHead>Thời gian gọi</TableHead> : null}
                  {isCallLog ? <TableHead>Trạng thái</TableHead> : null}
                  {isCallLog ? <TableHead className="w-36">Ảnh</TableHead> : null}
                  <TableHead>Mô tả ngắn</TableHead>
                  <TableHead className="w-40">Tác vụ</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
          ...
          <div className="flex items-center justify-end gap-2 border-t border-stone-100 px-4 py-3 text-sm text-stone-500">
            <span>Trang {safePage} / {pageCount}, tổng {items.length} mục</span>
        ...
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Bạn có chắc muốn xóa {deletingItems.length} nhật ký không? Hành động này không thể khôi phục.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
