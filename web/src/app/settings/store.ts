...
export const useSettingsStore = create<SettingsStore>((set, get) => ({
  ...
  loadBackups: async (silent = false) => {
    ...
    try {
      ...
      if (!silent) {
        toast.error(error instanceof Error ? error.message : "Tải danh sách backup thất bại");
      }
    } finally {
      if (!silent) {
  ...
  runBackup: async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Chạy backup thất bại");
    } finally {
  ...
  removeBackup: async (key) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Xóa backup thất bại");
    } finally {
  ...
  testBackup: async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Kiểm tra kết nối backup thất bại");
    } finally {
  ...
  toggleRegister: async () => {
    ...
    try {
      ...
      set({ registerConfig: data.register });
      toast.success(registerConfig.enabled ? "Đã dừng tác vụ đăng ký" : "Đã bắt đầu tác vụ đăng ký");
    } catch (error) {
  ...
  browseFiles: async (pool) => {
    ...
    try {
      ...
      toast.success(`Đọc thành công, có ${files.length} tài khoản từ xa`);
    } catch (error) {
