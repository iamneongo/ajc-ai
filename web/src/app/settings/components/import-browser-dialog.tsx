      ...
      <DialogContent showCloseButton={false} className="max-h-[90vh] max-w-5xl rounded-2xl p-6">
        <DialogHeader className="gap-2">
          ...
          <DialogDescription className="text-sm leading-6">
            {browserPool ? `Từ ${browserPool.name || browserPool.base_url}` : "Danh sách tài khoản từ xa vừa đọc được"}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="relative min-w-[260px]">
            ...
            <Input
              ...
              placeholder="Tìm email hoặc tên file"
        ...
        <div className="rounded-xl border border-stone-200">
          ...
          <div className="max-h-[420px] overflow-auto">
            {pagedFiles.length === 0 ? (
              <div className="flex items-center justify-center py-12 text-sm text-stone-400">Không có tài khoản từ xa nào khớp</div>
            ) : (
        ...
        <div className="flex items-center justify-between text-sm text-stone-500">
          <span>
            ...
            {Math.min(safeFilePage * currentPageSize, filteredFiles.length)} / {filteredFiles.length}
          </span>
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
