      ...
      <DialogContent showCloseButton={false} className="rounded-2xl p-6">
        <DialogHeader className="gap-2">
          ...
          <DialogDescription className="text-sm leading-6">
            {editingPool ? "Chỉnh sửa thông tin kết nối CPA" : "Thêm một kết nối CLIProxyAPI mới"}
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Ví dụ: hồ chính, hồ dự phòng"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder={editingPool ? "Để trống để giữ nguyên khóa" : "Khóa quản lý CPA"}
