        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Đặt địa chỉ cơ sở cho AJC AI tại máy này. Ứng dụng vẫn dùng biến môi trường `CHATGPT2API_BASE_URL` để tương thích cấu hình hiện tại.</p>
            </div>
          </div>
        ...
        {isLoadingConfig ? (
          ...
          <>
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-stone-500">Để trống để dùng biến môi trường hoặc giá trị mặc định; khi lưu sẽ tự động cắt khoảng trắng đầu cuối.</p>
            </div>
