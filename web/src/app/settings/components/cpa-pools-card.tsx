    ...
    <Card className="rounded-2xl border-white/80 bg-white/90 shadow-sm">
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Hãy cấu hình kết nối trước, sau đó truy vấn tài khoản từ xa và chọn nhập vào hồ tài khoản cục bộ.</p>
            </div>
          </div>
        ...
        {isLoadingPools ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-stone-50 px-6 py-10 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-stone-400">Bấm "Thêm kết nối" để lưu thông tin CLIProxyAPI của bạn.</p>
            </div>
          </div>
        ) : (
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          <p className="font-medium text-stone-600">Hướng dẫn</p>
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>Khi vào trang, hệ thống sẽ đọc các kết nối CPA đã cấu hình sẵn.</li>
            <li>Sau khi bấm "Đồng bộ" ở một kết nối, danh sách tài khoản từ xa sẽ được tải về để frontend hiển thị cho bạn chọn.</li>
            <li>Sau khi xác nhận, backend sẽ tải access_token tương ứng ở nền và nhập vào hồ tài khoản cục bộ.</li>
            <li>Frontend chỉ polling tiến độ nhập, không trực tiếp tham gia quá trình tải xuống.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
